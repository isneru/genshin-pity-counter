    ...
    <>
      ...
      <div className="h-screen flex justify-center items-center">
        <form
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  min={0}
                  max={90}
                  className={clsx("px-3 h-8 rounded bg-black w-full focus:outline-none focus:ring-2", `ring-${theme}`)}
          ...
          <button
            className={clsx(
              "mt-4 py-3 px-4 rounded font-semibold text-md transition-colors focus:ring-2",
